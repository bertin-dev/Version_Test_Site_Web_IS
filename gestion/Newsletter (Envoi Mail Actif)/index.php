 ...
 <?php
    if(isset($_GET['email'])) // On vérifie que la variable $_GET['email'] existe.
    {
        ...
        if (preg_match("#^[a-z0-9._-]+@[a-z0-9._-]{2,}\.[a-z]{2,4}$#", $_POST['email'])) // On vérifie qu'on a bien rentré une adresse e-mail valide.
        {
            ...
            $email = $_POST['email'];
            $message = 'Pour valider votre inscription à la newsletter de MonSite.fr, <a href="http://www.the-builders.org/Newsletter/public/inscription.php?tru=1&amp;email='.$email.'">cliquez ici</a>.';
