...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="description" lang="fr" content="Développement Web à Institut Salomon. Un centre de formation professionnel">
    ...
    <title>Développement Web | INSTITUT SALOMON</title>
...
<?php include('header.html'); ?>
	...
	<section id="blog" class="container">
         <div class="center">
            <h2>SPECIALITE: <span>INFORMATIQUE</span> / Développement D'Applications Web</h2>
            <p class="lead">Le développeur ou analyste-programmeur conçoit et développe des applications informatique, en transcrivant un besoin en une solution informatique écrite dans un langage informatique.</p>
        </div>
        ...
        <div class="blog">
            <div class="row">
                 <div class="col-md-8">
                    <div class="blog-item">
                        <div class="row">
                             <?php  include('user comment heart.php');?>
						...
						<div class="tab-content wow bounceInDown" data-wow-offset="0" data-wow-delay="0.4s">
                           ...
                           <strong>Méthodes & processus d'informatisation : </strong>systèmes informatique, typologie, architectures, Méthode systémique (MERISE), Méthode à objet  (UML)<br>
                           <strong>Bases de données : </strong>Conception et spécification de schémas relationnels, langage SQL, pratique d'un SGBD relationnel, programmation avec SQL2<br>
                          <strong>Développement  web : </strong>Architecture, client/serveur, le langage (x)HTML, Les CMS, Les protocoles SMTP, POP, & http, programme sur Visual basic<br>
                          <strong> Programmation : Algorithmique, programmation Java, Langage pascal<br>
                         Insertion professionnelle et pratiques de l'entreprise : </strong>Aptitude à l'Informatique (bureautique et Internet) ; Organisation de l'entreprise ; Outils et techniques d'entreprenariat.
                         <strong> Maitrise des IDE à l'instar de : </strong>DEVC++, codeblock, notepad++, Adobedreamsweaver, Eclipse, NetBeans, MS visual studio etc...
								</p>
							</div>
							
							<div class="tab-pane" id="metier">
								<p><strong>Analyste programmeur,  Développeur d'applications ou Webmaster </strong></p>
							</div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
							  ...
							  <ul class="blog_archieve">
                                    <li><a href="#"><i class="fa fa-angle-double-right"></i> Durée de Formation: <span class="pull-right">  </a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right"></i> Niveau Minimum requis: <span class="pull-right">1ère </a></li>
                                    <li><a href="#"><i class="fa fa-angle-double-right"></i> Lieu: <span class="pull-right">PK8, Douala</a></li>
									<li><a href="#"><i class="fa fa-angle-double-right"></i> Cible: <span class="pull-right">Toute Personne Curieuse</a></li>
									<li><a href="#"><i class="fa fa-angle-double-right"></i> Stage en Entreprise: <span class="pull-right">2 Mois</a></li>
                              </ul>
						</div>  
							...
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="../images/" alt=""></a>
								</div>
