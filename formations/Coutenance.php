...
<head>
    ...
    <meta name="description" lang="fr" content="COUTENANCE INSTITUT SALOMON Un centre de formation professionnel">
    ...
    <title>Coutenance | INSTITUT SALOMON</title>
...
<?php include('header.html'); ?>
	...
	<section id="blog" class="container">
         <div class="center">
            <h2>SPECIALITE: <span>TRAINING DE HAUT NIVEAU</span> / Coutenance</h2>
            <p class="lead">La bonne maîtrise des activités PMO (Project Management Office) est essentielle afin d’assurer un véritable pilotage projet. La planification et la coûtenance sont des activités essentielles qui doivent être parfaitement maîtrisées afin d’estimer une situation à terminaison la plus juste possible et au plus tôt afin d’assurer la mise en place de plan d’actions en temps et en heure.</p>
        </div>
                 ...
                 <div class="col-md-8">
                    <div class="blog-item">
                        <div class="row">
							...
							<li><a href="#exercice" data-toggle="tab"><i class="icon-briefcase"></i>Objectifs</a></li>
    ...
    Maîtriser le coût de ses projets : analyser et contrôler en permanence les écarts et les dérives.<br>
    Acquérir les outils et principes de la coûtenance de projet.<br>
    Élaborer un budget de référence et savoir estimer le coût prévisionnel du projet.<br>
    Sortir du pilotage par les délais et maîtriser les principes et méthodes d’un pilotage par les coûts.<br>
    Diagnostiquer l’état d’avancement du projet et estimer régulièrement les coûts des activités.<br>
    ...
    Une formation opérationnelle sur un sujet à fort enjeu financier<br>
    Une approche progressive des techniques et méthodes pour maîtriser et réduire les coûts d’un projet, afin de prévenir les dérives<br>
    L’expérience d’un expert "terrain", intervenant sur de nombreux projets d’entreprises<br>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
							 ...
							 <ul class="blog_archieve">
                                    ...
                                    <li><a href="#"><i class="fa fa-angle-double-right"></i> Niveau Minimum requis: <span class="pull-right">Terminale </a></li>
