...
<body>
<?php 
      //if( (isset($_SESSION['contact_Etu']) AND !empty($_SESSION['contact_F'])) OR (isset($_SESSION['contact_Etu']) AND !empty($_SESSION['contact_F'])) )
		  if( isset($_SESSION['contact_Etu']) OR isset($_SESSION['contact_F']) )
	{
include('bbcode0.php');
...
// On met dans une variable le nombre de messages qu'on veut par page		
		 ...
		 {
		?>	
			 <center><u><strong><h1 style="color: black;">FORMATEURS INDISPONIBLES POUR LE MOMENT</h1></strong></u></center>
	    <?php
		 }
        ?>	
