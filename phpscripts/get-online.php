...
$req0=$db->prepare('SELECT * FROM membres WHERE pseudo=:pseudo');
...
$query = $db->prepare("
	SELECT online_id, online_id, online_user, online_status, online_time, id_membre, pseudo,avatars
	FROM chat_online 
	LEFT JOIN membres ON membres.id_membre = chat_online.online_user
...
<h4 align="left">En ligne(<?php echo $rslt01['nbrs_connecte'];?>)</h4>
<div align="left">
